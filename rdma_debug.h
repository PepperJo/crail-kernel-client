...
#ifndef _RDMA_DEBUG_H
#define _RDMA_DEBUG_H
...
#define DBG_CONN		0x00000002
#define DBG_CLIENT		0x00000004
#define DBG_CQ			0x00000008
#define DBG_POLL		0x00000010
#define DBG_QP			0x00000020
#define DBG_ALL		(DBG_ON | DBG_CONN | DBG_CLIENT | DBG_CQ | DBG_POLL | \
		DBG_QP)
